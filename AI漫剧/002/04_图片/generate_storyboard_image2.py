...
TASKS = [
    ...
    },
    {
        ...
        "prompt": "\n".join(
            [
                COMMON,
                "镜头 scene_002_b：巨鼓象战鼓车轮登场。巨鼓象以夸张战鼓车轮形态从闪耀大赛赛场入口滚入，低机位侧向构图。必须保留巨鼓象本体、象鼻、鼓形机械结构、四条象腿和精灵特征；四条腿要从战鼓周围自然伸出；表情慌而不凶，像想停但停不下来；鼓轮贴地转动。可以有轻微说话表情。",
                "不要汽车化，不要变成普通轮胎或车辆，不要人形化，不要新增角色，不要少腿或把腿藏进鼓里，不要文字字幕，不要 UI。",
            ]
        ),
    },
]
